define([], function(){
    ...
    var renderDOM = function(){
        ...
        console.log(document.getElementById("menu.about").textContent)

        var tagStr = $tag?'<span class="viewer-title">'+document.getElementById("menu.tags").textContent+'</span><div class="viewer-div tagcloud" id="js-mobile-tagcloud"></div>':"";
        var friendsStr = $friends?'<span class="viewer-title">'+document.getElementById("menu.link").textContent+'</span><div class="viewer-div friends" id="js-mobile-friends"></div>':"";
        var aboutmeStr = $aboutme?'<span class="viewer-title">'+document.getElementById("menu.about").textContent+'</span><div class="viewer-div aboutme" id="js-mobile-aboutme"></div>':"";
